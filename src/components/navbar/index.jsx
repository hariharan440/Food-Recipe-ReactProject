...
export default function Navbar() {
    const { searchParam, setSearchParam, handleSubmit } = useContext(GlobalContext); // Changed handlesubmit to handleSubmit
    ...
    return (
        <nav className="flex justify-between items-center py-8 container mx-auto flex-col lg:flex-row gap-5 lg:gap-0">
            ...
            <form onSubmit={handleSubmit}> {/* Changed handlesubmit to handleSubmit */}
                <input 
                    type="text"
                    name="search"
                    value={searchParam}
